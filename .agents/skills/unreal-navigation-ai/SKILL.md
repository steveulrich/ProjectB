...
description: "Implement or diagnose Unreal 5.8 navigation, path following, decision graphs, perception, EQS, or Smart Object interactions."
---
...
10. For affected behavior or the selected acceptance gate, debug selected agents and profile worst-case populations in a cooked target build.
