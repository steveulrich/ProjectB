...
description: "Tune or extend Unreal 5.8 Character Movement, special movement modes, root-motion displacement, and client movement prediction."
---
...
8. For affected behavior or the selected acceptance gate, verify at varied frame rate, target hardware, slopes/steps/edges, and network conditions.
