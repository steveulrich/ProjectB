---
name: unreal-pcg
description: "Author or diagnose Unreal 5.8 PCG graphs, point metadata, spawning, generation scheduling, and persistent or runtime world population."
---
...
Consult [`references/data-model-graph-design.md`](references/data-model-graph-design.md) when changing graph structure or metadata contracts.
...
10. For affected behavior or the selected acceptance gate, profile node cost, scheduling, instance count, memory, CPU/GPU transfers, and visual pops.
