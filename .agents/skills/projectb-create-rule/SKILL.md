---
name: projectb-create-rule
description: "Create or edit persistent project instructions when requested. Read-only questions or audits of AGENTS.md do not trigger rule authoring."
---
...
Infer the narrowest useful scope from the request and affected files. Ask only if scope remains consequentially ambiguous:
- "Should this rule always apply, or only when working with specific files?"

Infer concrete patterns from the named files and repository. If materially different matches remain plausible, ask:
