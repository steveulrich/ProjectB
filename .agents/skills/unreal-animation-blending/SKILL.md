...
description: "Design or fix Unreal 5.8 AnimGraph composition, locomotion blends, transitions, phase synchronization, additives, and body-region layering."
---
...
Consult [`references/method-selector.md`](references/method-selector.md) when choosing or changing the mechanism.
...
6. For affected behavior or the selected acceptance gate, validate notifies, root motion, sync markers, interruptions, and network behavior.
7. For affected behavior or the selected acceptance gate, profile graph evaluation and confirm thread-safe data access.
