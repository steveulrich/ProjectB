...
description: "Implement or diagnose Unreal 5.8 Enhanced Input actions, mapping contexts, triggers, modifiers, input ownership, and player key profiles."
---
...
Consult [`references/architecture.md`](references/architecture.md) when changing the input model, and
[`references/contexts-ownership.md`](references/contexts-ownership.md) when changing context lifetime or ownership.
...
Consult [`references/triggers-modifiers.md`](references/triggers-modifiers.md) when changing trigger or modifier semantics. Do not assume
