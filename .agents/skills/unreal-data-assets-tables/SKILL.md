...
description: "Design or change Unreal 5.8 asset/table schemas, identifiers, Asset Manager discovery, loading references, or cook inclusion for data-driven content."
---
...
7. For affected behavior or the selected acceptance gate, validate identifiers, ranges, references, duplicate rows, cross-row relationships,
   and cook inclusion before runtime.
8. Test in a cooked build when changing discovery, loading references, cook inclusion, or packaged behavior, or when the gate requires it. Editor discovery and successful PIE loading do not prove that
