...
description: "Build or debug Unreal 5.8 material graphs, instances, layers, shading models, texture inputs, and surface effects."
---
...
Consult [`references/architecture-selector.md`](references/architecture-selector.md) when choosing or changing the mechanism.
...
7. For affected behavior or the selected acceptance gate, test representative instances and worst-case screen coverage.
