...
description: "Implement or debug Unreal 5.8 GAS ability ownership, activation, costs, cooldowns, targeting, prediction, cancellation, and cleanup."
---
...
Consult [`references/architecture.md`](references/architecture.md) when changing ASC ownership, initialization, or ability architecture.
