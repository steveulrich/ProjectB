...
- Find referencers before deletion. Explicit approval must cover the affected nonempty dependency set; existing approval for that exact scope remains valid. Present newly discovered referencers and consequences before requesting any missing approval.
