...
description: "Design or refactor Unreal 5.8 Blueprint ownership, communication, dependencies, and lifecycle boundaries; diagnose defects caused by those boundaries."
---
...
Consult [`references/communication-patterns.md`](references/communication-patterns.md) when choosing or changing communication boundaries.
...
7. For affected behavior or the selected acceptance gate, test lifecycle, duplicate binding, teardown, map travel, respawn, multiplayer authority,
