...
Candidate `LAN-20260907-03` is the latest completed artifact and passed the two-process late-join valid-hero admission path. Selection display and clean frontend return still fail; see the active gate at the end of this document. Both packaged test processes exited normally. The candidate 01 records that follow are historical, including its resolved process/prompt state.
