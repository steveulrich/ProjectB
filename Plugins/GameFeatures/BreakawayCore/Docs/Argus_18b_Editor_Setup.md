...
- [x] Press **1** → placement preview ghost appears (valid/invalid tint)
- [x] **LMB** on valid spot → Siege Engine spawns and **rolls forward**
- [x] **LMB** on invalid spot (red ghost) → stays in placement; can reposition
- [x] **RMB** → cancels preview; no spawn
- [x] During placement: **LMB does not Primary**; **RMB does not Request Relic**
- [x] During placement: **F** (or other hero ability) **cancels preview** and runs that ability
- [x] After placement ends: Primary and Request Relic work normally
- [x] Rolling barrel damages **enemy buildables** (~200 DPS) for up to **10s**, then destroys itself
- [x] Siege Engine has **250 HP** if attacked before/during roll
- [x] **Once per round:** second placement in same round blocked
- [x] **Round 2:** placement allowed again; surviving barrels **persist**
- [x] Relic pickup / score regression still OK
...
| Item                                                                                  | Step |
| ------------------------------------------------------------------------------------- | ---- |
| Sheet-accurate ability kits (No Retreat, For Glory, Retribution, Argus defense Slide) | 18c — see [Argus_18c_Editor_Setup.md](./Argus_18c_Editor_Setup.md) |
| Cooldown/damage parity                                                                | 18c  |
| Siege Engine VFX/SFX polish                                                           | optional polish |
