...
Art can be attached to the zone or placed alongside it without changing healing or purchase logic. The zone currently has no player-visible marker and is not placed in the playable maps. Placement, presentation, tuning, and multiplayer evidence remain outstanding.
