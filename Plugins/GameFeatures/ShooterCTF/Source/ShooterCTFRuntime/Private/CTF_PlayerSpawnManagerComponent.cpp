...
UE_DEFINE_GAMEPLAY_TAG_STATIC(TAG_LYRA_CaptureTheRelic_TeamOneSpawn, "Lyra.CaptureTheRelic.TeamOne");
UE_DEFINE_GAMEPLAY_TAG_STATIC(TAG_LYRA_CaptureTheRelic_TeamTwoSpawn, "Lyra.CaptureTheRelic.TeamTwo");
...
AActor* UCTF_PlayerSpawnManagerComponent::OnChoosePlayerStart(AController* Player, TArray<ALyraPlayerStart*>& PlayerStarts)
{
	...
	{
	case 1:
		TeamSpawnTag = TAG_LYRA_CaptureTheRelic_TeamOneSpawn;
		break;
	case 2:
		TeamSpawnTag = TAG_LYRA_CaptureTheRelic_TeamTwoSpawn;
		break;
		default:
			return nullptr;
		break;
