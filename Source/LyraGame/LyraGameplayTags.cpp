...
namespace LyraGameplayTags
{
	...
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(InputTag_Confirm, "InputTag.ConfirmTargeting", "Confirms an ability's targeting.");
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(InputTag_Cancel, "InputTag.CancelTargeting", "Cancels an ability's targeting.");
